...
abstract class NetworkHelper {
  ...
  Future<Result<dynamic, dynamic>> fetchData(
      {required url, required headers}) async {
  ...
  Future<Result<dynamic, dynamic>> postData(
      {required String url, required Map body, required headers}) async {
    var endpoint = Uri.parse(url);
